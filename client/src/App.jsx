      ...
      >
        <div className="relative flex flex-col w-1/6 border-r-3 border-gray-700">
          ...
          <button
            ...
            className="absolute inset-x-0 bottom-0 flex flex-row align-middle items-center justify-center mx-2 mb-2 py-2 px-4 gap-2 bg-blue-800 rounded-lg drop-shadow-md drop-shadow-gray-500 border-blue-700 hover:brightness-110 active:brightness-90 cursor-pointer shrink-0"
          >
            <img
